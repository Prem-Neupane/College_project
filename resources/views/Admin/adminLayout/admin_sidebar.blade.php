		...
		<ul class="nav menu">			
			...
			<li class="parent">
				...
				<ul class="children collapse" id="sub-item-2">
					...
					<li>
						<a href="{{ url('view/teachers_list') }}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Teacher's Table</a>
					</li>

					<li>
							<a href="{{ url('view/students_list') }}"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Student's Table</a>
					</li>
