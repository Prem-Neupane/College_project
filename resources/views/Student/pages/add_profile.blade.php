...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        <div class="row">
                ...
                <li><a href="{{ url('teacher/add_profile') }}"><svg class="glyph stroked home"><use xlink:href="#stroked-home"></use></svg></a></li>
                        <li class="active">Student's Details Form</li>
                </ol>
        </div><!--.row-->
...
<div class="row">
        ...
        {{Form::text('first_name',$student->first_name,['class'=>'form-control','placeholder'=>'Your First Name'])}}
    </div>
    <div class="form-group col-md-6">
        {{Form::label('name','Your Last Name')}}
        {{Form::text('last_name',$student->last_name,['class'=>'form-control','placeholder'=>'Your First Name'])}}
    </div>
</div>
...
<div class="row">
        ...
        {{Form::text('username',$student->username,['class'=>'form-control col-md-6','placeholder'=>'User Name'])}}
        </div>

         <div class="form-group col-md-6">
        {{Form::label('role','User Role')}}
        {{Form::text('role',$student->identity,['class'=>'form-control col-md-6','placeholder'=>'User Role In this Institution'])}}
        </div>
</div>
<div class="row">
       <div class="col-md-6">
                ...
                <div class="col-md-6">
                        @if($student->gender==1)
                <input type="radio" name="gender" value="{{$student->male}}" checked> Male<br>
                <input type="radio" name="gender" value="{{$student->female}}"> Female<br>              
                @else
        ...
        <div class="form-group col-md-6">
                ...
                {{Form::email('email',$student->email,['class'=>'form-control col-md-6','placeholder'=>'your emailaddress'])}}
        </div>
